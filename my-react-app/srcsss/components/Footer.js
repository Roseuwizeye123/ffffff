            ...
            <ul className="list-unstyled d-flex flex-column">
              <li className="mb-3">
                <a href="https://www.facebook.com/uwizeye.marie.75?mibextid=ZbWKwL">
                  <img src={facebook} alt="Facebook" /><span className="px-2">Instagram</span>
                </a>
              </li>
              <li className="mb-3">
                <a href="#">
                  <img src={instagram} alt="Instagram" /><span className="px-2">Instagram</span>
                </a>
              </li>
              <li className="mb-3">
                <a href="#">
                  <img src={twitter} alt="Twitter" /><span className="px-2">Twitter</span>
                </a>
              </li>
              <li className="mb-3">
                <a href="#">
                  <img src={youtube} alt="YouTube" /><span className="px-2">Youtube</span>
                </a>
              </li>
            </ul>
